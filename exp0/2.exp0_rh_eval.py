...
summary_table.to_csv(FIG_DIR + 'global_rh.csv', float_format='%.2e')

# What is the range of the grid cell values historically & in the future???
files = [DATA_DIR + "field/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_field.nc",
         DATA_DIR + "field/CCCma_CanESM5_historical_r4i1p1f1_Lmon_rh_gn_v20190429_field.nc",
         DATA_DIR + "field/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_field.nc",
         DATA_DIR + "field/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_field.nc"]
...
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'grid_rh.csv', float_format='%.2e')



# Now let's just make some maps of the Mean grid cell
d1 = xr.open_dataset(DATA_DIR + "field/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_field.nc")
d2 = xr.open_dataset(DATA_DIR + "field/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_field.nc")
...
files = [DATA_DIR + "error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_mse.nc",
         DATA_DIR + "error_metrics/CCCma_CanESM5_historical_r4i1p1f1_Lmon_rh_gn_v20190429_mse.nc",
         DATA_DIR + "error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_mse.nc",
         DATA_DIR + "error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_mse.nc"]
...
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'self_RMSE_rh.csv', float_format='%.2e')


# Now let's just make some maps of the RMSE
d1 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_mse.nc")
d2 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_mse.nc")
...
files = [DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_ns.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r4i1p1f1_Lmon_rh_gn_v20190429_ns.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_ns.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_ns.nc"]
...
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'self_NS_rh.csv', float_format='%.2e')


# Now let's just make some maps of the NA
d1 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_ns.nc")
d2 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_ns.nc")
...
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'self_NS_rh_drop_antartic.csv', float_format='%.2e')
...
files = [DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r4i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc"]
...
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'self_ctbias_rh.csv', float_format='%.2e')


# Now let's just make some maps of the NA
d1 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc")
d2 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc")
d1 = d1.where(d1.lat > -60)
d2 = d2.where(d2.lat > -60)
...
# ctvar ----------------------------------------------------------------------------------------------------
# Now let's take a loko at the ctbias
files = [DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r4i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc",
         DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc"]
...
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'self_ctvar_rh.csv', float_format='%.2e')


# Now let's just make some maps of the NA
d1 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_historical_r10i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc")
d2 = xr.open_dataset(DATA_DIR+"error_metrics/CCCma_CanESM5_ssp585_r10i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc")
d1 = d1.where(d1.lat > -60)
d2 = d2.where(d2.lat > -60)
