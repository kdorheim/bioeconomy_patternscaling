...
files = ["exp0/data/error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_mse.nc"]
...
files = [ERROR_DIR+"rh_r4i1p1f1_mse1.nc",
         ERROR_DIR+"rh_r4i1p1f1_mse2.nc",
         ERROR_DIR+"rh_r10i1p1f1_mse1.nc",
         ERROR_DIR+"rh_r10i1p1f1_mse2.nc"]
...
plt.savefig(FIG_DIR + "fut_RMSE_rh.png", dpi=300, bbox_inches='tight')
plt.show()

summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'fut_RMSE_rh.csv', float_format='%.2e')

# Now let's just make some maps of the RMSE
d1 = xr.open_dataset(ERROR_DIR+"rh_r4i1p1f1_mse1.nc")
d2 = xr.open_dataset(ERROR_DIR+"rh_r10i1p1f1_mse2.nc")
...
plt.savefig(FIG_DIR + "fut_RMSE_rh_map.png", dpi=300, bbox_inches='tight')
plt.show()
...
files = ["./exp0/data/error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_ns.nc"]
...
files = [ERROR_DIR+"rh_r4i1p1f1_ns1.nc",
         ERROR_DIR+"rh_r4i1p1f1_ns2.nc",
         ERROR_DIR+"rh_r10i1p1f1_ns1.nc",
         ERROR_DIR+"rh_r10i1p1f1_ns2.nc"]
...
plt.xlabel(metric_name)
plt.title(title_name)
plt.savefig(FIG_DIR + "fut_ns_rh.png", dpi=300, bbox_inches='tight')
plt.show()

to_plot = pd.concat([bench_data, futu_data], ignore_index=True)
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'fut_ns_rh.csv', float_format='%.2e')

# Now let's just make some maps of the NS
d1 = xr.open_dataset(ERROR_DIR+"rh_r4i1p1f1_ns1.nc")
d1 = d1.where(d1.lat > -60)
...
#point_lat = 26
#point_lon = 360-80
#d1.sel(lat=26, lon=280, method="nearest")['rh'].values


d2 = xr.open_dataset(ERROR_DIR+"rh_r10i1p1f1_ns2.nc")
d2 = d2.where(d2.lat > -60)
...
plt.savefig(FIG_DIR + "fut_NS_rh_map.png", dpi=300, bbox_inches='tight')
plt.show()


# ctbais ----------------------------------------------------------------------------------------------------
# Now let's take a look at the NS, recall the benchamrk data is coming from exp0
files = ["./exp0/data/error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_ctbias.nc"]
...
files = [ERROR_DIR+"rh_r4i1p1f1_ctbias1.nc",
         ERROR_DIR+"rh_r4i1p1f1_ctbias2.nc",
         ERROR_DIR+"rh_r10i1p1f1_ctbias1.nc",
         ERROR_DIR+"rh_r10i1p1f1_ctbias2.nc"]
...
plt.xlabel(metric_name)
plt.title(title_name)
plt.savefig(FIG_DIR + "fut_ctbais_rh.png", dpi=300, bbox_inches='tight')
plt.show()
...
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'fut_ctbais_rh.csv', float_format='%.2e')

# Now let's just make some maps of the ctbais
d1 = xr.open_dataset(ERROR_DIR+"rh_r4i1p1f1_ctbias1.nc")
d2 = xr.open_dataset(ERROR_DIR+"rh_r10i1p1f1_ctbias2.nc")
d1 = d1.where(d1.lat > -60)
d2 = d2.where(d2.lat > -60)
...
plt.savefig(FIG_DIR + "fut_ctbias_rh_map.png", dpi=300, bbox_inches='tight')
plt.show()
...
files = ["./exp0/data/error_metrics/CCCma_CanESM5_ssp585_r4i1p1f1_Lmon_rh_gn_v20190429_ctvar.nc"]
...
files = [ERROR_DIR+"rh_r4i1p1f1_ctvar1.nc",
         ERROR_DIR+"rh_r4i1p1f1_ctvar2.nc",
         ERROR_DIR+"rh_r10i1p1f1_ctvar1.nc",
         ERROR_DIR+"rh_r10i1p1f1_ctvar2.nc"]
...
plt.xlabel(metric_name)
plt.title(title_name)
plt.savefig(FIG_DIR + "fut_ctvar_rh.png", dpi=300, bbox_inches='tight')
plt.show()
...
summary_table = to_plot.groupby('exp_en')['value'].describe()
summary_table = summary_table[['mean', 'std', 'min', 'max']]
summary_table.to_csv(FIG_DIR + 'fut_ctvar_rh.csv', float_format='%.2e')

# Now let's just make some maps of the ctbais
d1 = xr.open_dataset(ERROR_DIR+"rh_r4i1p1f1_ctvar1.nc")
d2 = xr.open_dataset(ERROR_DIR+"rh_r10i1p1f1_ctvar2.nc")
d1 = d1.where(d1.lat > -60)
d2 = d2.where(d2.lat > -60)
...
plt.savefig(FIG_DIR + "fut_ctvar_rh_map.png", dpi=300, bbox_inches='tight')
plt.show()
