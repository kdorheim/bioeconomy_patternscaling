...
# scenario data it is different from the expo0 in that the low NPP/Rh regions will be
# filtered out (excluded from the pattern scaling).
...
for index, row in to_process.iterrows():
    ...
    if VAR == "tas":
       ...
       # Calculate the total annual carbon. Update attributes to reflect the
        ...
        percentile_5 = np.nanpercentile(abs(field[VAR].values), 0.05)
        field[VAR] = field[VAR].where(field[VAR] >= percentile_5)
